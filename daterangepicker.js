...
(function (root, factory) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (typeof options.template !== "string" && !(options.template instanceof $))
            options.template =
                ...
                '<div class="holiday-header-toggle"></div>' +
                '<div class="holiday-header-content"></div>' +
                "</div>" +
        ...
        if (typeof options.locale === "object") {
            ...
            if (typeof options.locale.holidayLabel === "string") this.locale.holidayLabel = options.locale.holidayLabel;
        }
        ...
        if (typeof options.holidays === "object") this.holidays = options.holidays;

        if (typeof options.showHolidayHeader === "boolean") this.showHolidayHeader = options.showHolidayHeader;
        ...
        this.container.find(".holiday-header-toggle").html(this.locale.holidayLabel);
    ...
    DateRangePicker.prototype = {
        ...
        renderHolidayHeader: function () {
            if (!this.showHolidayHeader || !this.holidays || this.holidays.length === 0) {
                this.container.find(".holiday-header").hide();
                return;
            }

            this.container.find(".holiday-header").show();

            var startMonth = this.leftCalendar.month ? this.leftCalendar.month : this.startDate;
            var endMonth = this.rightCalendar.month ? this.rightCalendar.month : this.endDate;
            ...
            visibleHolidays.sort(function (a, b) {
        ...
        renderCalendar: function (side) {
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    var holidayData = this.isHoliday(calendar[row][col]);
                    if (holidayData !== false) {
                        classes.push("holiday");
                        if (holidayData.class) {
                            classes.push(holidayData.class);
                        }
                    }
        ...
        toggleHolidayHeader: function (e) {
            e.stopPropagation();
            var content = this.container.find(".holiday-header-content");
            var toggle = this.container.find(".holiday-header-toggle");
